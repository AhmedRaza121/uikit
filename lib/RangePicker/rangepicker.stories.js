...
exports["default"] = exports.Standard = exports.Control = void 0;
...
var Template = function Template(args) {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_RangePicker["default"], _objectSpread({}, args));
};

var Standard = Template.bind({});
exports.Standard = Standard;

var Control = function Control(args) {
  var controller = function controller(props) {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_RangePicker["default"], {
      ...
      onValueChange: function onValueChange(_ref) {
        ...
        var start = updatedValue.start,
            end = updatedValue.end;
        setRange({
          start: {
            value: start !== null && start !== void 0 ? start : ''
          },
          end: {
            value: end !== null && end !== void 0 ? end : ''
          }
        });
      },
      onValueSet: function onValueSet(_ref2) {
